...
public class DeveloperController {
    ...
    public DeveloperResponse getById(@PathVariable int id){
        ...
        return new DeveloperResponse(developers.get(id), "Data has been retrieved successfully.", 200);
    }
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
        ...
        return new DeveloperResponse(developers.get(developer.getId()), "Data has been successfully saved.", 201);
    }
    ...
    public DeveloperResponse update(@PathVariable int id, @RequestBody Developer developer){
        ...
        return new DeveloperResponse(developers.get(id), "Data has been successfully updated.", 200);
    }
    ...
    public DeveloperResponse delete(@PathVariable int id){
        ...
        return new DeveloperResponse(developer, "Data has been successfully deleted.", 200);
    }
}
